...
local u6 = g:add_vertex()
local u7 = g:add_vertex()
g:add_edge(u3, u1)
g:add_edge(u3, u2)
g:add_edge(u7, u3)
g:add_edge(u6, u4)
g:add_edge(u6, u5)
g:add_edge(u7, u6)
local uv_order = topological_sort(g.u, g.uv)
local vu_order = topological_sort(g.u, g.vu)
assert(table.concat(uv_order, " ") == "1 2 3 4 5 6 7")
assert(table.concat(vu_order, " ") == "7 3 1 2 6 4 5")
